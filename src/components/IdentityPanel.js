...
export default function IdentityPanel(props) {
    ...
    return (<>
        <div>
            ...
            <h5>Known Issues (As of 11-18-23 - 10:30pm CST)</h5>
            <ul>
                ...
                <li>Bioware in 2nd Edition only has 1 grade. So some strangeness with having to change the dropdown to load it correctly. Will work on that!</li>
            </ul>
        </div>
        <hr/>

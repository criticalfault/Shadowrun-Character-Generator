...
export default function AttributesPanel(props) {
  ...
  const [Quickness, setQuickness] = React.useState(
    props.currentCharacter.attributes.Quickness
  );
  const [Strength, setStrength] = React.useState(
    props.currentCharacter.attributes.Strength
  );
  const [Charisma, setCharisma] = React.useState(
    props.currentCharacter.attributes.Charisma
  );
  const [Intelligence, setIntelligence] = React.useState(
    props.currentCharacter.attributes.Intelligence
  );
  const [Willpower, setWillpower] = React.useState(
    props.currentCharacter.attributes.Willpower
  );
  const [Initative] = React.useState(
    props.currentCharacter.attributes.Initative
  );
  ...
  const handleChangeAttribute = (event) => {
    ...
    if (
      parseInt(AttributeSum) -
        parseInt(props.currentCharacter.maxAttributePoints) >=
      0
    ) {
  ...
  const [increaseAttributeTarget, setIncreaseAttributeTarget] =
    useState("Body");
  ...
  const increaseAttributeConfirm = () => {
    ...
    let AttributeStart =
      props.currentCharacter.attributes[increaseAttributeTarget];
    let AttributeFinal = (props.currentCharacter.attributes[
      increaseAttributeTarget
    ] += 1);
  ...
  const calcIncreaseAttributeTarget = () => {
    ...
    let attributeCost =
      KarmaCosts[props.Edition]["racialLimits"][props.currentCharacter.race][
        increaseAttributeTarget
      ];
    ...
    if (
      ...
      return (
        (props.currentCharacter.attributes[increaseAttributeTarget] + 1) *
        KarmaCosts[props.Edition].costs.overLimit
      );
    } else if (
      props.currentCharacter.attributes[increaseAttributeTarget] <
      attributeCost["limit"]
      ...
      return (
        (props.currentCharacter.attributes[increaseAttributeTarget] + 1) *
        KarmaCosts[props.Edition].costs.underLimit
      );
    } else {
      ...
      >
        <Box sx={style}>
          ...
          <Button
            variant="contained"
            color="primary"
            onClick={increaseAttributeConfirm}
          >
            Are you sure?
          </Button>
          <hr></hr>
      ...
      {/* <table>
        ...
        <tbody>
          <tr>
            ...
            <td>
              <input
                ...
                disabled={lockAttributes()}
              />
            </td>
            {displayImproveAttribute("body", "Body")}
            <td>{props.currentCharacter.raceBonuses["Body"]}</td>
            <td>
              {parseInt(props.currentCharacter.cyberAttributeBonuses["Body"])}
            </td>
            <td>
              {parseInt(props.currentCharacter.magicalAttributeBonuses["Body"])}
            </td>
            <td>
              {parseInt(Body) +
                parseInt(props.currentCharacter.raceBonuses["Body"]) +
                parseInt(props.currentCharacter.cyberAttributeBonuses["Body"]) +
                parseInt(
          ...
          <tr>
            ...
            <td>
              {parseInt(
                props.currentCharacter.cyberAttributeBonuses["Strength"]
              )}
            </td>
            <td>
              {parseInt(
                props.currentCharacter.magicalAttributeBonuses["Strength"]
              )}
            </td>
            <td>
              {parseInt(Strength) +
                parseInt(props.currentCharacter.raceBonuses["Strength"]) +
                parseInt(
                  props.currentCharacter.cyberAttributeBonuses["Strength"]
                ) +
                parseInt(
          ...
          <tr>
            ...
            <td>
              {parseInt(
                props.currentCharacter.cyberAttributeBonuses["Charisma"]
              )}
            </td>
            <td>
              {parseInt(
                props.currentCharacter.magicalAttributeBonuses["Charisma"]
              )}
            </td>
            <td>
              {parseInt(Charisma) +
                parseInt(props.currentCharacter.raceBonuses["Charisma"]) +
                parseInt(
                  props.currentCharacter.cyberAttributeBonuses["Charisma"]
                ) +
                parseInt(
          ...
          <tr>
            ...
            <td>
              {parseInt(
                props.currentCharacter.cyberAttributeBonuses["Willpower"]
              )}
            </td>
            <td>
              {parseInt(
                props.currentCharacter.magicalAttributeBonuses["Willpower"]
              )}
            </td>
            <td>
              {parseInt(Willpower) +
                parseInt(props.currentCharacter.raceBonuses["Willpower"]) +
                parseInt(
                  props.currentCharacter.cyberAttributeBonuses["Willpower"]
                ) +
                parseInt(
          ...
          <tr>
            <td>Reaction:</td>
            <td>
              {Math.floor((parseInt(Quickness) + parseInt(Intelligence)) / 2)}
            </td>
            {displayImproveAttribute("empty", false)}
            ...
            <td>
              {parseInt(
                props.currentCharacter.magicalAttributeBonuses["Reaction"]
              )}
            </td>
            <td>
              {Math.floor(

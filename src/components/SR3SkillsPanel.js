      ...
      <Grid container spacing={2}>
        <Grid size={12}>
          <Box sx={{ background: "#fafafa", padding: "20px" }}>
            ...
            <FormControl>
              <InputLabel id="skill-label" shrink shrink>Skills Categories</InputLabel>
              <NativeSelect
                id="skill-dropdown"
            ...
            {selectedCategory && (
              <FormControl style={{ width: "400px" }}>
                <InputLabel id="skill-label" shrink shrink>{selectedCategory}</InputLabel>
                <NativeSelect
                  id="skill-dropdown"
                  value={newSkill}
            ...
            <>
              <FormControl style={{ width: "400px", marginLeft: "20px" }}>
                <InputLabel id="specialization-label" shrink shrink>
                  Specialization
                </InputLabel>
                <NativeSelect
            ...
            {selectedKnowledgeCategory && (
              <FormControl style={{ width: "400px", marginBottom: "20px" }}>
                <InputLabel id="skill-label" shrink shrink>
                  {selectedKnowledgeCategory}
                </InputLabel>
                <NativeSelect
                  id="skill-dropdown"

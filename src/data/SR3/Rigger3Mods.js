...
export const Accessories = [
...

  {
    ...
    category: 'Accessories',
    types: {
      standardBench:     { designDp: 0,  cfConsumed: 6, loadReduction: '150 kg', customPartsCost: '750¥',   customCfConsumed: 6, customLoadReduction: '100 kg' },
      foldingBench:      { designDp: 0,  cfConsumed: 6, loadReduction: '150 kg', customPartsCost: '750¥',   customCfConsumed: 6, customLoadReduction: '100 kg' },
      standardBucket:    { designDp: 0,  cfConsumed: 6, loadReduction: '150 kg', customPartsCost: '700¥',   customCfConsumed: 6, customLoadReduction: '100 kg' },
      reinforcedBench:   { designDp: 5,  cfConsumed: 8, loadReduction: '300 kg', customPartsCost: '1,500¥', customCfConsumed: 8, customLoadReduction: '300 kg' },
      reinforcedBucket:  { designDp: 5,  cfConsumed: 8, loadReduction: '250+ kg', customPartsCost: '1,500¥ + 100¥ per 25 kg of support capacity above 250', customCfConsumed: 8, customLoadReduction: '250+ kg' },
      armoring:          { designDp: 12, cfConsumed: null, loadReduction: null, customPartsCost: '1,250¥ per Armor point', customCfConsumed: null, customLoadReduction: null, note: 'Per Armor point. Max 2 Armor points on bench seat (protects from rear only).' },
    },
    design: {
      dpCost: 'Standard Bench/Bucket Seat: 0 | Folding Bench Seat: 0 | Reinforced Bench/Bucket Seat: 5 | Armoring: 12 per Armor point',
      cfConsumed: 'Standard/Folding Bench/Bucket: 6 | Reinforced: 8',
      loadReduction: 'Standard Bench/Bucket: 150 kg | Reinforced Bench: 300 kg | Reinforced Bucket: 250+ kg',
      maxImprovement: null,
    },
    customization: {
      partsCost: 'Standard Bench: 750¥ | Folding Bench: 750¥ | Reinforced Bench: 1,500¥ | Standard Bucket: 700¥ | Reinforced Bucket: 1,500¥ + 100¥ per 25 kg above 250 support capacity | Armoring: 1,250¥/Armor point',
      partsAvailability: '3/48 hrs (1)',
      equipmentRequired: 'Vehicle shop',
      baseTime: '4 hrs',
      skillTest: 'Appropriate Vehicle B/R (4)',
      cfConsumed: 'Standard/Folding Bench/Bucket: 6 | Reinforced Bucket: 8',
      loadReduction: 'Standard Bench/Bucket: 100 kg | Reinforced Bench: 300 kg | Reinforced Bucket: 250+ kg',
      maxImprovement: null,
    },
    note: 'Bench seats: 2 passengers (3 if cramped) or 200 kg; not for motorcycles. Removing any seat frees 6 CF. Folding bench: freed CF usable for cargo up to 150 kg when folded. Bucket seats: 1 passenger. Reinforced seats support orks, trolls, large metahumans. Armored bench/bucket seats protect against incoming fire penetrating the vehicle (bench seats: rear attacks only, max 2 Armor points). Metahuman-adjusted variants replace all standard seats with reinforced seating; count all bench and bucket seats and multiply by 1,200¥.',
  },

  {
    ...
    category: 'Accessories',
    sidecarTable: [
      { size: 'Small',  cargoCf: 6,  handlingModifier: +1, designDp: 10, customCost: '1,000¥' },
      { size: 'Medium', cargoCf: 8,  handlingModifier: +1, designDp: 20, customCost: '2,000¥' },
      { size: 'Large',  cargoCf: 12, handlingModifier: +2, designDp: 35, customCost: '3,500¥' },
    ],
    design: {
      dpCost: 'Small: 10 | Medium: 20 | Large: 35',
      cfConsumed: null,
      loadReduction: null,
      maxImprovement: null,
    },
    customization: {
      partsCost: 'Small: 1,000¥ | Medium: 2,000¥ | Large: 3,500¥',
      partsAvailability: null,
      equipmentRequired: null,
      baseTime: '15 minutes',
      skillTest: null,
    ...
    note: 'Motorcycles only. Three sizes: small, medium, large. Cargo capacity does not include seating (seating must be taken out of sidecar\'s CF). Motorcycle\'s Load rating does not change. Reduces cycle\'s Speed by 15, increases Handling by sidecar modifier, decreases Economy by 10% (multiply initial Economy × 0.9). Same Body rating as motorcycle. Sidecar armor can be increased per standard vehicle-modification rules (p.131). Installing/removing: 15 minutes.',
  },

  {
    ...
    customization: {
      partsCost: '600¥',
      partsAvailability: '4/96 hrs (1.5)',
      equipmentRequired: 'Vehicle shop',
      baseTime: '24 hrs',
      skillTest: 'Appropriate Vehicle B/R (4)',
      cfConsumed: null,
    ...
    note: 'Projects concentrated beam of light. Effective range 600 m, beam diameter 0.5 m at origin and 5 m at maximum range (beam widens proportionally — at 300 m, beam is 300/600 × (0.5 + 5) = 2.75 m). Also available in medium-range infrared (invisible to unaugmented human eye, illuminates areas for low-light and thermographic imaging systems). May be controlled manually or remotely operated from inside the vehicle.',
  },

  {
    ...
    design: { dpCost: null, cfConsumed: null, loadReduction: null, maxImprovement: null,
      note: 'All vehicles fitted with appropriate tires at manufacture for no extra cost. Special tire types are paid for only when requested during vehicle design or replace during customization.' },
    customization: { partsCost: 'See tire type below', partsAvailability: null, equipmentRequired: 'Standard toolkit', baseTime: null, skillTest: null, cfConsumed: null, loadReduction: null, maxImprovement: null,
      note: 'Spare tires take up CF = half Body (round down).' },
    tireTypes: [
      { type: 'Standard',      cost: 'Body × 50¥ each',  note: 'Reduce by half (round down) the effects of any suspension or Handling modifications.' },
      { type: 'Performance',   cost: 'Body × 75¥ each',  note: 'Required for use with improved suspension and drive-by-wire systems. Negate effects of off-road or active suspensions in off-road mode.' },
      { type: 'Off-Road',      cost: 'Body × 25¥ each',  note: 'Required for use with off-road suspensions or active suspensions in off-road mode. With all other suspension types, behave as standard tires (negate benefits of improved suspension and drive-by-wire during on-road operation).' },
      { type: 'Dual-Purpose',  cost: 'Body × 250¥ each', note: 'For use with active suspensions. Vehicles can operate both off-road and on-road without penalty. Act like standard tires with regard to improved and high-speed suspensions. Any vehicle with improved suspension or drive-by-wire also equipped with dual-purpose tires.' },
      { type: 'Runflat',       cost: 'Tire cost + 200¥ each', note: 'Available for all aforementioned tire types. Equivalent protection of an armored vest (5/3).' },
    ],
    note: 'All tire types require a standard toolkit to install.',
  },

  {
    ...
    design: {
      dpCost: '3,000',
      cfConsumed: '10',
      loadReduction: '400 kg',
      maxImprovement: null,
    },
    customization: {
      partsCost: '1,000,000¥',
      partsAvailability: '10/2 wks (3)',
      equipmentRequired: 'Vehicle shop, Electronics shop',
      baseTime: '5 days',
      skillTest: 'Appropriate Vehicle B/R Skill (5), Electronics B/R (5)',
      cfConsumed: '15',
      loadReduction: '500 kg',
      maxImprovement: null,
    },
    note: 'One-patient medical shop robotic drone designed for tele-surgery. See Valkyrie system, p.139, M&M. Includes rigger adaptation, remote-control interfaces, satellite uplink, datajack port, robotic Pilot 5 (with Adaptation Pool 5), and space for one patient.',
  },

  {
    ...
    design: {
      dpCost: "Winch's Load rating ÷ 100",
      cfConsumed: null,
      loadReduction: 'Body × 2.5 kg',
      maxImprovement: 'See Winch Capacity Table',
    },
    customization: {
      partsCost: "Winch's Load rating ÷ 2¥",
      partsAvailability: '6/14 days (2)',
      equipmentRequired: 'Vehicle facility',
      baseTime: 'Body × 16 hrs',
      skillTest: 'Appropriate Vehicle B/R (4)',
    ...
    note: 'Attached to bumpers of ground vehicles. Can pull and tow heavy loads. Has its own Load rating/weight capacity (max per Winch Capacity Table). Players can select winches with Load ratings lower than the maximum for their vehicle\'s Body. When used to pull or tow while moving, towing maximum is the lower of vehicle\'s or winch\'s Load rating. Vehicle can also use a winch to pull itself across normally impassable terrain (e.g. up a vertical cliff face) — vehicle must not be over its Load rating; winch pulls at 1 m per turn; vehicle cannot perform any other actions while the winch is working. See Lifting and Pulling Objects, p.64.',
  },
